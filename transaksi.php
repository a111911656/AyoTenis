...
<head>
    ...
    <title>Ayo Tenis || Pemesanan</title>
    <!-- Custom Theme Style -->
     ...
     ?>
        ...
        <div class="panel panel-default">
		  ...
		  // membuat kode urut otomatis sebagai ID booking
						...
						$sel = mysqli_query($koneksi, "select lapangan.*, operator.alamat, operator.kota, operator.nama_lapangan from lapangan inner join operator on (lapangan.username=operator.username) where id_lap = '$id_lap'");
                        ...
                        <form class="form-horizontal form-label-left" method="post">
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                              <input type="text" id="last-name" name="last-name" required="required" class="form-control col-md-7 col-xs-12" value="<?php echo $pilih['nama_lapangan'];?>, <?php echo $pilih['alamat']; ?>" readonly>
                            </div>
                          </div>
                          <div class="form-group">
...
if($simpan & $jenis_bayar=='transfer'){ //jika simpan data berhasil dan jenis bayar = transfer 
	...
	echo "<script> alert(\"Segera Lakukan Pembayaran Kepada Operator Tenis Yang Dituju\"); window.location = \"index.php\"; </script>";
		} else { //dan jika tidak
