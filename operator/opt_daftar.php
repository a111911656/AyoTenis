...
<html lang="en">
<head>
  <title>Ayo Tenis || Pendaftaran Operator</title>
  <meta charset="utf-8">
  ...
  <div class="container">
    ...
    <form class="form-horizontal" action="opt_pro_reg.php" method="post" enctype="multipart/form-data">
      ...
      <div class="form-group">
       ...
       <div class="form-group">
        <div class="col-sm-1"></div>
        <label class="control-label col-sm-3" for="email">Nama Lapangan</label>
        <div class="col-sm-4">
          <input type="text" class="form-control" name="nama_lapangan" id="pwd" placeholder="Nama Lapangan" required>
        </div>
        <div class="col-sm-4"></div>
      </div>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-4"></div>
               ...
               <div class="form-group">
                ...
                <div class="col-sm-4">
                  <input type="text" class="form-control" name="kota" id="pwd" placeholder="Kota Lapangan" required>
                </div>
                <div class="col-sm-4"></div>
              </div>
