        ...
        <div class="panel panel-default">
          ...
          <hr>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                              <h4>Nama Lapangan &nbsp;&nbsp;: <?php echo $w['nama_lapangan']; ?> </h4>
                            </div>
                          </div>
                          ...
                          <div class="form-group">
                            ...
                            <div class="col-md-7 col-sm-7 col-xs-12">
                              <h3 align="center">Selamat bermain dengan menunjukkan halaman ini atau dengan menunjukkan bukti email yang telah dikirim ke email Anda kepada Operator tempat tenis</h3>
                            </div>
                          </div>
