                       ...
                       <?php 
                        ...
                        <tr>
                         <!-- menampilkan data dari tabel operator pada database -->
                          ...
                          <td><?php echo $sel['nama_lapangan']; ?></td>
                          <td><?php echo $sel['alamat']; ?></td>
                          <td><?php echo $sel['kota']; ?></td>
                          <td><?php echo $sel['email']; ?></td>
                          <!-- <td><a href="#" class="btn btn-warning btn-xs"><i class="fa fa-pencil"></i> Edit </a><a href="#" class="btn btn-danger btn-xs"><i class="fa fa-trash"></i> Delete </a></td> -->
                        </tr>
                        <?php } ?>
                      </tbody>
                    </table>
